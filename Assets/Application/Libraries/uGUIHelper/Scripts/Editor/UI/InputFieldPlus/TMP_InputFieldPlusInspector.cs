...
namespace TMPro.EditorUtilities
{
	...
	[CustomEditor(typeof(TMP_InputFieldPlus), true)]
	public class TMP_InputFieldPlusInspector : SelectableEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			if (m_foldout.fontSettings)
			{
				...
				{
					TMP_InputFieldPlus inputField = target as TMP_InputFieldPlus;
				...
				if (!m_ContentType.hasMultipleDifferentValues)
				{
					...
					if (m_ContentType.enumValueIndex == (int)TMP_InputFieldPlus.ContentType.Standard ||
						m_ContentType.enumValueIndex == (int)TMP_InputFieldPlus.ContentType.Autocorrected ||
						m_ContentType.enumValueIndex == (int)TMP_InputFieldPlus.ContentType.Custom)
					{
						EditorGUI.BeginChangeCheck();
					...
					if (m_ContentType.enumValueIndex == (int)TMP_InputFieldPlus.ContentType.Custom)
					{
						...
						if (m_CharacterValidation.enumValueIndex == (int)TMP_InputFieldPlus.CharacterValidation.Regex)
						{
							EditorGUILayout.PropertyField(m_RegexValue);
						}
						else if (m_CharacterValidation.enumValueIndex == (int)TMP_InputFieldPlus.CharacterValidation.CustomValidator)
						{
