		...
		public override void OnInspectorGUI()
		{
			...
			using( new EditorGUI.DisabledScope( m_TextComponent == null || m_TextComponent.objectReferenceValue == null ) )
			{
				...
				if (!m_ContentType.hasMultipleDifferentValues)
				{
					...
					if (m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentTypes.Standard ||
						m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentTypes.Autocorrected ||
						m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentTypes.Custom)
						EditorGUILayout.PropertyField(m_LineType);

					if (m_ContentType.enumValueIndex == (int)InputFieldPlus.ContentTypes.Custom)
					{
