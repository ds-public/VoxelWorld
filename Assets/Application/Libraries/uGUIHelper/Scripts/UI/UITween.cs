...
namespace uGUIHelper
{
	...
	public class UITween : UIBehaviour
	{
		...
		{
			int c = 0 ;
			UITween[] tweens = UIEditorUtility.FindComponents<UITween>
			(
				"Assets/Application",
				( _ ) =>
				{
//					_.m_InteractionDisableInPlaying = _.interactionDisableInPlaying ;
	...
	//		EasePunch
		...
		override protected void Start()
		{
			...
			if( Application.isPlaying == true && ( m_PlayOnAwake == true || m_Running == true ) )
			{
		...
		{
			m_OnFinishedAction?.Invoke( m_Identity, this ) ;
		}
...
//			tCanvasGroup.blocksRaycasts = true ;
		...
		public void Play( float delay = -1, float duration = -1, float offset = 0, Action<string,UITween> onFinishedAction = null )
		{
			enabled = true ;
