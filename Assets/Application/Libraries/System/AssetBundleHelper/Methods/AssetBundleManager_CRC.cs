...
namespace AssetBundleHelper
{
	...
	public partial class AssetBundleManager
	{
		...
		{
			return GetCRC32( CRC32_MASK, data ) ^ CRC32_MASK ;
		}
		...
		/// <param name="data"></param>
		/// <returns></returns>
		internal protected static uint GetCRC32( uint crc, byte[] data )
		{
			return GetCRC32( crc, data, data.Length ) ;
		}
		...
		/// <param name="crc"></param>
		/// <returns></returns>
		internal protected static uint GetCRC32( uint crc )
		{
