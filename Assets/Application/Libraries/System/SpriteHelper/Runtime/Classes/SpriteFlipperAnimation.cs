...
{
	/// <summary>
	/// パラパラアニメの情報を保持する Version 2023/12/16
	/// </summary>
	[CreateAssetMenu( fileName = "SpriteFlipperAnimation", menuName = "ScriptableObject/Helper/SpriteHepler/SpriteFlipperAnimation" )]
	public class SpriteFlipperAnimation : ScriptableObject
	{
		[SerializeField]
		...
		protected List<FrameData> m_Frames = new () ;
