...
/// </summary>
public class Build_MasterData
{
	private const string m_TargetRootPath	= "Assets/Application/Database/MasterData" ;
	private const string m_OutputPath		= "Assets/StreamingAssets/dbs/MasterData.bin" ;

	[MenuItem("Build/Database/MasterData", priority = 0)]
	internal static void Process()
	{
		...
		if( data != null && data.Length >  0 )
		{
			...
			Debug.Log( "<color=#00FF00>[Build MasterData] Completed ! : Size = " + data.Length + "</color>" ) ;
		}
	}
