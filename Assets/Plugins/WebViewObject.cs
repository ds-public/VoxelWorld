...
#endif
*/
using Callback = System.Action<UnityEngine.GameObject,string>;
/*
#if UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
...
*/
        ...
        float ml = mMarginLeftComputed, mt = mMarginTopComputed, mr = mMarginRightComputed, mb = mMarginBottomComputed;
		/*
		#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN || UNITY_EDITOR_LINUX
				//TODO: UNSUPPORTED
		#elif UNITY_WEBPLAYER || UNITY_WEBGL
...
//		if (onError != null)
//		{
			onError?.Invoke(gameObject,error);
//		}
    }
...
//		if (onHttpError != null)
//		{
			onHttpError?.Invoke(gameObject,error);
//		}
    }
...
//		if (onStarted != null)
//		{
			onStarted?.Invoke(gameObject,url);
//		}
    }
...
//		if (onLoaded != null)
//		{
			onLoaded?.Invoke(gameObject,url);
//		}
    }
...
#endif // !UNITY_ANDROID
            onJS?.Invoke(gameObject,message);
//		}
    }
...
//		{
 ...
 #endif // UNITY_2018_4_OR_NEWER
#endif // !UNITY_ANDROID
            onHooked?.Invoke(gameObject,message);
//		}
    }
...
*/
	...
	public void Call()
	{
		onJS?.Invoke( gameObject, m_Message ) ;
	}
	...
	public Action<WebViewObject,string>	OnLoaded ;
	public Action<WebViewObject,string> OnError ;
}
